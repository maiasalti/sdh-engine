...
**Direction:** drug-pool
**Angle:** SSTR2 selective dependency in SDHB-deficient PPGL — PRRT with lutetium-177 DOTATATE (Lutathera)
**Papers added:** 1 — PMID 41928014 (SSTR2 selective vulnerability in SDHB-KD PPGL cells, Mol Biomed 2026)
**Papers rejected (logged to tracker.md):** 1 (PMID 41942355 — broad GIST review, SDH is one of several WT subtypes)
**Summary:** PubMed scan surfaced a directly SDH-relevant new mechanistic paper (PMID 41928014, Mol Biomed Apr 2026): systematic SSTR functional profiling in PPGL cell lines showed that SDHB knockdown drives selective SSTR2 membrane upregulation and receptor internalization — and that a selective SSTR2 agonist (BIM-23120) reduces proliferation and induces apoptosis ONLY in SDHB-deficient cells, not WT, via dephosphorylation of AKT/ERK/survival pathways. This is a genuinely new, SDHB-specific vulnerability not previously represented in the engine. Added the `sstr2-somatostatin-receptor` pathway, SSTR2 target, and lutetium-177 DOTATATE (Lutathera, FDA-approved in GEP-NETs, NCI Phase 2 NCT03206060 recruiting in inoperable PGL/PCC, evidence_score 52, clinical_trial). Also noted NCT06607692 (LuPARPed trial combining Lutathera + olaparib in SSTR-positive solid tumors including PGL/PCC) as a combinatorial signal. Updated sdh-biology.ts with a new SSTR2 section (mechanism 12, renumbering neddylation to 13) and druggable targets table. Candidate directions not yet explored: (1) ferroptosis via GPX4/SLC7A11 axis (ether-PE lipidomics signal in SDHB-KD cells from PMID 42249664 + elevated basal ROS; no SDH-specific direct evidence yet but mechanistically credible), (2) ATRX loss as precision biomarker for PARP inhibitor sensitivity in metastatic SDHB-PPGL (co-mutation in ~50% of metastatic cases, ALT pathway → HRD-like), (3) DFMO/eflornithine (ODC inhibitor upstream of polyamine pathway — distinct enzyme from DENSPM/SSAT direction but same broader theme).
**PR:** morning/2026-07-10-sstr2-prrt
