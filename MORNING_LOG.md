...
**Direction:** drug-pool
**Angle:** Reductive carboxylation / ACLY dependency — bempedoic acid (FDA-approved ACLY inhibitor) as an SDH-selective biosynthetic vulnerability
**Papers added:** 0
**Papers rejected (logged to tracker.md):** 0 (all papers returned by today's PubMed searches were already present in tracker.md)
**Summary:** The engine already states that SDH-deficient cells use "reductive glutamine metabolism … via reductive carboxylation" but had no drug targeting ACLY — the bottleneck cytoplasmic enzyme that converts reductively generated citrate into acetyl-CoA for fatty acid synthesis and histone acetylation. The mechanistic foundation is Mullen et al., Nature 2012 (PMID 22101431): 13C isotopic tracing in ETC-defective tumour cells (Complex I, Complex III, and fumarate hydratase mutations — the latter being directly analogous to SDH loss) showed that reductive carboxylation is the dominant citrate-synthesis pathway and that ACLY is the essential bottleneck enzyme. Added: (1) new `reductive-carboxylation` pathway with the ACLY → acetyl-CoA axis; (2) ACLY as a new target gene (UniProt P53396); (3) bempedoic acid (Nexletol, FDA-approved 2020 for LDL lowering; CLEAR Outcomes Phase 3 safety data; PMID 37585218) as a theoretical drug candidate with evidence_score 35. A secondary AMPK-activating effect of bempedoic acid is also relevant (opposes mTOR-driven growth in SDH-deficient tumours). Key limitation: ACSL1-dependent prodrug activation may reduce potency in non-hepatic tumour tissue; dedicated preclinical validation in SDH-deficient cell lines is the critical next step. NOTE: Two prior runs (morning/2026-07-09-kdm4-dna-repair-ym155 and morning/2026-07-10-sstr2-prrt) made additions not yet merged into main — their content is not reflected in this log; the owner should review those PRs before or alongside this one. Candidate directions not yet explored (distinct from all merged runs): (1) DFMO/eflornithine (ODC1 inhibitor — FDA-approved neuroblastoma, upstream of elevated polyamine biosynthesis in SDH-deficient tumours, no SDH-specific data); (2) ATRX co-mutation as an HRD biomarker for PARP inhibitor selection in SDHB metastatic PPGL; (3) direct FASN inhibitor (denifanstat/TVB-2640, Phase 2) — one step downstream of ACLY in the same lipogenic axis.
**PR:** morning/2026-07-11-acly-reductive-carboxylation
