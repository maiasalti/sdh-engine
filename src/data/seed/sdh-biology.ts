...
### 19. SSTR2 Neuroendocrine Vulnerability — Full Agonism and PRRT Double-Hit
A 2026 study by García-Vioque et al. (Mol Biomed 2026, PMID 41928014) performed systematic functional profiling of somatostatin receptor agonists in SDHB-knockdown versus wild-type pheochromocytoma/paraganglioma cell lines and uncovered a selective pharmacological vulnerability: SDHB-deficient cells show greater SSTR2 membrane expression and enhanced receptor internalization capacity, and respond to the selective SSTR2 full agonist BIM-23120 with selective proliferation arrest and apoptosis that is absent in wild-type cells. Partial agonists — octreotide, lanreotide, pasireotide — are completely ineffective, providing a direct mechanistic explanation for why cold somatostatin analogues repeatedly fail in PPGL clinical trials while PRRT (which reaches the same receptor via 177Lu-DOTATATE) succeeds through a distinct radioligand delivery mechanism.

**Selective full agonism in SDHB-deficient cells:**
SDH loss, particularly SDHB mutation, drives pseudohypoxic HIF-2α stabilisation, which upregulates neuroendocrine transcriptional programmes including SSTR2. Beyond transcriptional upregulation, SDHB-deficient cells specifically exhibit increased SSTR2 membrane clustering and enhanced receptor internalisation rates versus WT. Full SSTR2 agonism via BIM-23120 activates the Gi protein cascade maximally — inhibiting adenylyl cyclase, reducing cAMP, and dephosphorylating downstream MAPK and PI3K/AKT pro-survival kinase cascades. In SDHB-deficient cells, this signal is sufficient to tip the balance from growth to growth arrest and apoptosis; in WT cells, the same receptor activation does not reach this threshold. Partial agonism by octreotide or pasireotide delivers insufficient Gi-coupling amplitude, failing to reach the pro-apoptotic threshold in either cell type.

**PRRT radiobiological double-hit:**
The elevated SSTR2 membrane density in SDH-deficient PPGL creates a second therapeutic advantage: increased uptake of 177Lu-DOTATATE radioligand per tumour cell, delivering a higher radiation dose to SDH-deficient tumours relative to SSTR2-low counterparts. Critically, this enhanced radiation dose is applied to cells already harbouring the SDH-driven BRCAness phenotype (Mechanism 14): succinate-mediated inhibition of KDM4A/KDM4B → H3K9me3 persistence at DSB sites → defective HR initiation. PRRT-induced β-radiation generates DSBs that SDH-deficient cells cannot repair via homologous recombination — creating a double-hit: higher delivered dose (from elevated SSTR2) plus impaired repair capacity (from SDH-driven HR deficiency). This convergence may partly explain the clinical observation that SSTR2-expressing SDHB-PPGL achieve objective responses to PRRT in retrospective series, even though these tumours are rarely cured by any systemic therapy.

**Drug candidates:**
- **BIM-23120** (research compound): selective SSTR2 full agonist; proof-of-concept for the full-agonism requirement in SDHB-deficient cells (PMID 41928014); not in clinical trials; a drug-like full agonist SSTR2 compound with improved pharmacokinetics is the translational need.
- **177Lu-DOTATATE (Lutathera)**: FDA-approved for unresectable/progressive SSTR-positive GEP-NETs (NETTER-1 Phase 3 trial, Strosberg et al., NEJM 2017, PMID 28076709). 68Ga-DOTATATE PET/CT-confirmed SSTR2 expression required before treatment. Phase 3 ELIPSS trial (NCT03206060) investigated PRRT in PPGL specifically. Clinically used in SDHB-PPGL with SSTR2 expression per current genotype-directed PPGL guidelines (Glover et al., J Clin Endocrinol Metab 2026, PMID 42025325; Hernandez-Felix et al., Endocr Relat Cancer 2026, PMID 42454478).

**Key limitations:** (1) No published data confirm SSTR2 overexpression in SDHA-deficient GIST — this direction is most evidence-supported in SDH-deficient PCC/PGL, not GIST. (2) No randomised prospective trial specifically selects for SDH-deficient PPGL with PRRT. (3) The BRCAness-PRRT radiobiological synergy hypothesis has not been tested experimentally — it is mechanistic inference from established SDH-BRCAness (PMID 30013182; PMID 32494005) combined with the SSTR2-uptake advantage. (4) BIM-23120 is a research compound; clinical full-agonist candidates are needed. (5) Cold-analog ineffectiveness (PMID 41928014) must be communicated to avoid empirical prescribing of octreotide/lanreotide for anti-tumour purposes in SDHB-PPGL.
