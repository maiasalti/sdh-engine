...
### 25. GLUT1/Warburg Glycolytic Dependency — BAY-876

SDH loss enforces a dual glycolytic dependency that makes tumor cells constitutively reliant on GLUT1-mediated glucose import in a way that creates pharmacological vulnerability. The mechanism runs through two converging routes: HIF-1α-driven GLUT1 transcription and TCA truncation that eliminates the OXPHOS alternative to glycolytic ATP generation.

**Route 1 — HIF-1α → GLUT1 transcriptional upregulation:**
The SLC2A1 locus (encoding GLUT1) contains canonical hypoxia-response elements (HREs) in its promoter that are directly bound and activated by HIF-1α. In normal cells under normoxia, PHD1/2/3 hydroxylate HIF-1α → VHL-mediated ubiquitination → proteasomal degradation, keeping SLC2A1 expression low. In SDH-deficient tumors, accumulated succinate is a competitive inhibitor of PHDs (same α-KG-dependent dioxygenase family as TETs; Ki succinate ~100–200 μM vs. Km succinate ~0.5 μM): PHDs are chronically inhibited → HIF-1α is constitutively stabilized at normoxic oxygen tensions → HRE-driven SLC2A1 transcription is permanently active → GLUT1 is overexpressed on the tumor cell surface. This is canonical HIF-1α biology extrapolated from hundreds of hypoxia studies; the SDH-specific PHD inhibition mechanism producing the same outcome is established by the pseudohypoxia literature (Selak et al., Cancer Cell 2005).

**Route 2 — TCA truncation → glycolytic ATP dependency:**
SDH (Complex II) normally catalyzes succinate → fumarate, feeding electrons to ubiquinol and maintaining TCA cycle flux. Without functional SDH, the TCA cycle is truncated at succinate: fumarate, malate, oxaloacetate (OAA), and subsequent cycle intermediates are depleted. This forces cells to generate biosynthetic precursors via reductive carboxylation of glutamine (documented in SDH-deficient cells and VHL-null RCC), but critically also limits NADH production from the oxidative TCA cycle, reducing input to the electron transport chain (Complexes I/III/IV). The result is reduced OXPHOS-derived ATP capacity, making SDH-deficient cells more dependent on glycolysis as an ATP source — precisely the route GLUT1 inhibition would block.

**The VHL-null pseudohypoxic precedent — Chan et al. (Sci Transl Med 2011, PMID 21697397):**
VHL-null renal cancer cells are pseudohypoxic through the same PHD/HIF-1α mechanism as SDH-deficient tumors (VHL normally degrades HIF-α subunits; VHL loss → constitutive HIF-1α → constitutive GLUT1 upregulation). Chan et al. demonstrated selective killing of VHL-null 786-O and A498 renal carcinoma cells by STF-31, a thiazolidinedione-class GLUT1 inhibitor, while isogenic VHL-restored cells survived. Selectivity required GLUT1: VHL-restored cells downregulated GLUT1 expression (HIF-1α no longer stabilized) and were insensitive to STF-31. The key mechanistic insight is that pseudohypoxic GLUT1 upregulation creates a specific transport dependency — when GLUT1 is inhibited, pseudohypoxic cells cannot compensate because GLUT1 constitutes the dominant glucose import route in the HIF-driven state. The VHL-null cancer / SDH-deficient cancer mechanistic parallel (both: PHD inhibition → HIF-1α stable → GLUT1 overexpressed → glycolytic dependency) strongly motivates testing GLUT1 inhibitors in SDH-deficient models.

**FDG-PET clinical evidence of elevated glucose transport:**
18F-fluorodeoxyglucose (FDG) is a glucose analogue that enters cells via GLUT1 (and other GLUTs), is phosphorylated by hexokinase, and is trapped intracellularly as FDG-6-phosphate. FDG-PET avidity in SDH-deficient PPGL — confirmed in the PMID 42454478 imaging study (already in papers database, 2026 Eur J Nucl Med Mol Imaging) — provides indirect but clinically observable evidence that GLUT1-mediated glucose transport is elevated in vivo in SDH-deficient tumors. This is consistent with constitutive HIF-1α-driven GLUT1 upregulation.

**BAY-876 — best-in-class GLUT1 inhibitor (Siebeneicher et al., ChemMedChem 2016, PMID 27595555):**
BAY-876 is a Bayer compound identified through a GLUT1-focused medicinal chemistry program. Selectivity profile: IC50 GLUT1 ~2 nM; GLUT2 ~35 nM; GLUT3 ~134 nM; GLUT4 ~160 nM — yielding >17-fold selectivity over GLUT2, >67-fold over GLUT3, and >80-fold over GLUT4. This selectivity profile is substantially better than earlier GLUT1 inhibitors (STF-31, WZB117, cytochalasin B — which are either weak, non-selective, or reactive). BAY-876 inhibits 3H-2-deoxy-glucose uptake in cancer cell lines at nanomolar concentrations and reduces proliferative viability in glucose-dependent lines. It is currently a pharmacological tool compound with no clinical development.

**Key limitations:**
1. No SDH-specific data: no study has tested BAY-876 or any GLUT1 inhibitor in SDH-deficient GIST, PPGL, or RCC cell lines, patient-derived organoids, or animal models. The entire mechanistic rationale is extrapolation from VHL-null cancer and canonical HIF-1α biology — mechanistically sound but directly unvalidated in the SDH context.
2. BAY-876 is not in clinical development: it is a tool compound. Clinical translation of GLUT1 inhibitors has been limited by potential toxicity in GLUT1-dependent normal tissues (red blood cells — which rely on GLUT1 — and blood-brain barrier GLUT1 for cerebral glucose supply).
3. Compensatory glucose transport: cells under GLUT1 blockade may upregulate GLUT3 or GLUT4; while BAY-876's selectivity advantage delays this, sustained pharmacological pressure may be overcome.
4. SDH-deficient GIST grow slowly; the glycolytic ATP demand in very slow-proliferating tumors may be lower than in rapidly growing cancer lines used to validate BAY-876.

Evidence_score of 26 (preclinical) reflects a strong mechanistic foundation — canonical HIF → GLUT1 biology, the VHL-null pseudohypoxic precedent (Chan 2011, PMID 21697397), FDG-PET avidity clinical data — with no direct SDH-specific experimental evidence for GLUT1 inhibitor activity.
