...
| De Novo Lipogenesis (FASN) | FASN | TCA truncation drives reductive carboxylation → elevated acetyl-CoA → upregulated FASN-dependent lipogenesis; concurrent mtFASN/lipoylation impairment; G28UCM shows FASN-SDHB synthetic lethality in cell lines (PMID 41520938); TVB-2640/denifanstat (Phase 2) as lead clinical candidate |

### 15. De Novo Lipogenesis / FASN Synthetic Lethality
SDH loss creates a specific dependency on de novo fatty acid synthesis through two converging mechanisms. First, truncation of the TCA cycle at succinate impairs oxidative anaplerosis; to compensate, SDH-deficient cells upregulate reductive carboxylation of glutamine via reverse IDH1 activity, generating citrate that is exported from the mitochondria to the cytoplasm and cleaved by ATP-citrate lyase (ACLY) to acetyl-CoA. This cytoplasmic acetyl-CoA pool fuels elevated FASN (fatty acid synthase)-dependent de novo lipogenesis, supplying palmitate for membrane phospholipid biogenesis and signaling lipids at rates above those in TCA-intact cells. Second, SDH loss impairs the mitochondrial fatty acid synthesis (mtFASN) pathway, which is required for lipoic acid production and lipoylation of key enzyme complexes including pyruvate dehydrogenase (PDH) and α-ketoglutarate dehydrogenase (α-KGDH); this mtFASN disruption adds a second lipid-biosynthesis vulnerability layer.

Navarro-Marchena et al. (Pharmacol Res 2026, PMID: 41520938) provided direct evidence for this synthetic interaction: G28UCM, a compound inhibiting both cytoplasmic FASN and the mtFASN/lipoylation pathway, showed selective growth inhibition in SDHB-deficient cancer cells compared with SDHB-wild-type controls — establishing FASN-SDHB synthetic lethality in cell line models. TVB-2640/denifanstat is the most clinically advanced selective FASN inhibitor (oral, selective KR domain inhibitor, Phase 2 trials including NCT03808558 in advanced solid tumors). The critical open question is whether TVB-2640's FASN-only selectivity is sufficient to recapitulate the full SDHB-specific effect observed with G28UCM's dual FASN/mtFASN profile — dedicated experiments in SDH-deficient cell lines and xenograft models with TVB-2640 are needed before clinical exploration.
