...
### 25. HSP90 Chaperone Dependency for VHL-Independent HIF-1α Proteostasis — Ganetespib

The constitutive pseudohypoxia in SDH-deficient tumors is canonically attributed to succinate-mediated PHD inhibition preventing VHL-mediated HIF-1α ubiquitination (Mechanism 2). However, Isaacs et al. (Cancer Cell 2002, PMID 12186565) established a second, VHL-*independent* pathway for HIF-1α proteostatic stability: the HSP90 molecular chaperone (HSP90AA1/HSP90AB1). In VHL-null cells treated with geldanamycin (an ansamycin HSP90 inhibitor), HIF-1α protein was depleted by >80% via proteasomal degradation mediated by the CHIP/Hsp70/Hsp40 co-chaperone axis — even under conditions where the canonical PHD-VHL degradation pathway was completely absent.

**Two independent proteasomal gatekeeping pathways for HIF-1α:**
HIF-1α protein stability is maintained by two mechanistically distinct routes: (1) the PHD-VHL pathway — PHDs hydroxylate HIF-1α prolyl residues, VHL/CRL2 ubiquitinates the hydroxylated protein, and the 26S proteasome degrades it; and (2) the HSP90-chaperoned proteostasis pathway — HSP90 binds and stabilizes HIF-1α protein, preventing recognition by CHIP (an E3 ubiquitin ligase that targets HSP90 client proteins released from the chaperone complex). When HSP90 is inhibited, CHIP/Hsp70/Hsp40 route the misfolded, chaperone-free HIF-1α to proteasomal degradation. In SDH-deficient tumors where the PHD-VHL pathway is constitutively blocked by succinate, HIF-1α protein stability is maintained entirely by the HSP90 chaperone route. HSP90 inhibition removes this sole remaining stabilization mechanism and triggers proteasomal HIF-1α depletion — effective precisely because the PHD-VHL backup is absent.

**Ganetespib — second-generation, non-ansamycin HSP90 inhibitor:**
Ganetespib (STA-9090) is a resorcinol-class HSP90 inhibitor developed by Synta Pharmaceuticals that binds the HSP90 N-terminal ATP pocket with nanomolar affinity. Unlike first-generation ansamycin derivatives (geldanamycin, tanespimycin/17-AAG), ganetespib lacks benzoquinone-associated hepatotoxicity, has reduced ocular toxicity, and demonstrates superior potency. It reached Phase 2/3 clinical development (GALAXY-2 trial, NSCLC; I-SPY 2 breast cancer; sarcoma/GI Phase 1 NCT02192541).

**Mechanistic distinction from belzutifan:**
Belzutifan (Mechanism 1 drug) occupies the HIF-2α PAS-B hydrophobic pocket and prevents HIF-2α/ARNT dimerization, suppressing HIF-2α transcriptional activity without degrading HIF-2α protein. It has no activity against HIF-1α — the dominant HIF isoform in GIST and PPGL. Ganetespib degrades both HIF-1α AND HIF-2α proteins via proteasomal routing, eliminating not only their transcriptional output but their physical presence. In tumors where HIF-1α drives the dominant pseudohypoxic program (GIST, PPGL), HIF-1α protein depletion is a mechanistic advantage not achievable with belzutifan.

**Co-client polypharmacology:**
HSP90 stabilizes numerous oncoproteins co-relevant to SDH-deficient biology: CDK4 (constitutively active due to CIMP-driven p16/CDKN2A silencing; Mechanism 24), AKT/mTOR (Mechanism 4), VEGFR2/KDR (Mechanism 3), MET (Mechanism 20), and FGFR1 (Mechanism 9). Ganetespib simultaneously depletes all of these established HSP90 clients — a mechanistic poly-pharmacology that single-target inhibitors cannot replicate, and that is particularly relevant for SDH-deficient tumors that co-activate multiple HIF-driven receptor tyrosine kinase pathways simultaneously.

**Key limitation:** The Isaacs et al. 2002 geldanamycin result was established in VHL-null cells (RCC cell lines). Direct testing of ganetespib in PHD-inhibited or SDH-deficient systems (SDHA-null GIST, SDHB-deficient PPGL) has not been published. The mechanistic extrapolation from geldanamycin/VHL-null to ganetespib/PHD-inhibited SDH-deficient tumors is one step removed from direct evidence. This is the primary gap requiring experimental closure — a cell-line experiment testing ganetespib dose-response in isogenic SDH-deficient vs SDH-sufficient cells for HIF-1α protein levels would provide the critical proof-of-concept.
