...
export const SEED_PATHWAYS: Omit<Pathway, "id">[] = [
  ...
  {
    name: "Polyamine Metabolism / SAT1-Mediated ROS Amplification",
    slug: "polyamine-metabolism",
    description:
      "Polyamines (putrescine, spermidine, spermine) are polycationic amines essential for cell growth, DNA stabilization, and translation. Their catabolism is driven by spermidine/spermine N1-acetyltransferase 1 (SAT1/SSAT), which oxidizes spermidine and spermine to produce acetylated back-conversion intermediates and hydrogen peroxide (H2O2). In SDH-deficient cells, pre-existing mitochondrial ROS elevation from Complex II dysfunction renders them selectively vulnerable to additional H2O2 generated by SAT1 induction — a ROS-overload synthetic lethality. Targeted lipidomics in SDHB-knockdown pheochromocytoma cells demonstrated that the polyamine analog DENSPM triggered far greater caspase-3-dependent apoptosis and extensive ether-phospholipid/sphingomyelin remodeling in SDHB-deficient versus wild-type cells (Alli et al., Physiol Rep 2026, PMID 42249664).",
    upstream_event:
      "SDH loss → Complex II dysfunction → elevated mitochondrial ROS baseline → heightened vulnerability to further H2O2 from SAT1-mediated polyamine catabolism",
    downstream_effects: [
      "SAT1 induction by polyamine analogs (DENSPM)",
      "Spermidine/spermine oxidation generating H2O2",
      "Amplified oxidative burden exceeding antioxidant capacity in SDH-deficient cells",
      "Caspase-3-dependent apoptosis preferentially in SDHB-deficient cells",
      "Ether-phospholipid and sphingomyelin remodeling as lipid stress markers",
      "Selective lethality: SDHB-deficient vs. SDH-intact cells",
    ],
    druggable: true,
    display_order: 11,
  },
