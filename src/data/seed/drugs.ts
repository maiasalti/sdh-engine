...
export const SEED_DRUGS: SeedDrug[] = [
  ...
  },
  {
    ...
    mechanism_of_action:
      "Potent, selective inhibitor of all four fibroblast growth factor receptors (FGFR1/2/3/4). In SDH-deficient GISTs, SDH-loss-driven genome-wide DNA hypermethylation (CIMP) disrupts CTCF insulators at the 11q13 chromosomal locus, derepressing normally silenced FGF3 and FGF4 oncogenes. These ligands activate FGFR1 in an autocrine loop, driving tumor proliferation — a mechanism distinct from the KIT/PDGFRA signaling that drives conventional GIST. Rogaratinib blocks this loop. Phase 2 trial (NCT04595747) in advanced SDH-deficient GIST: 10/24 patients achieved partial response (ORR 41.7%), median PFS 31.0 months (95% CI 20.2–NR), 1-year PFS 77.4%. Hyperphosphatemia was seen across the cohort, confirming FGFR1 target engagement. This is the first trial demonstrating a molecularly-targeted therapy predicated on an epigenetic mechanism in SDH-deficient GIST (Merriam P et al., Nat Med 2026, PMID: 42191879, DOI: 10.1038/s41591-026-04376-9).",
    fda_approved: false,
    approved_indications: [],
    pathway_slugs: ["fgfr-autocrine", "epigenetic-dysregulation"],
  ...
  },
  {
    ...
    chembl_id: "CHEMBL3786771",
    pubchem_cid: "49803313",
    drug_class: "Pan-FGFR inhibitor (FGFR1/2/3/4)",
    mechanism_of_action:
      "Orally bioavailable, selective, continuous inhibitor of FGFR1/2/3/4 kinases. FDA-approved for FGFR-altered urothelial carcinoma. In SDH-deficient GISTs, the rogaratinib Phase 2 trial (Nat Med 2026, PMID: 42191879) demonstrated that pan-FGFR inhibition — blocking the FGF3/FGF4 autocrine loop driven by CIMP-induced 11q13 insulator disruption — achieves 41.7% ORR. Erdafitinib targets the same FGFR family (particularly FGFR1/2/3/4) and is FDA-approved, making it the most accessible analogue for SDH-deficient GIST patients. Has not yet been tested in a dedicated SDH-deficient GIST trial but shares the same mechanism. FDA approval is based on FGFR1/2/3/4 alterations in urothelial carcinoma (THOR trial, PMID: 36688350).",
    fda_approved: true,
    approved_indications: [
      "FGFR-altered locally advanced or metastatic urothelial carcinoma",
    ],
    pathway_slugs: ["fgfr-autocrine"],
    target_gene_symbols: ["FGFR1"],
    evidence_score: 67,
    status: "preclinical",
  },
  ...
  {
    name: "Pevonedistat",
    brand_names: ["MLN4924", "TAK-924"],
    chembl_id: "CHEMBL3119978",
    pubchem_cid: "24889392",
    drug_class: "NEDD8-activating enzyme (NAE) inhibitor",
    mechanism_of_action:
      "Mechanism-based inhibitor of the NEDD8-activating enzyme (NAE1/UBA3), the E1 enzyme that initiates the neddylation cascade. Neddylation of Cullin proteins is required for activation of Cullin-RING ubiquitin ligases (CRLs), the largest family of E3 ligases responsible for ubiquitin-mediated degradation of cell cycle regulators (CDT1, p27, WEE1) and signaling proteins. An unbiased CRISPR-Cas9 synthetic lethal screen in SDHB-deficient mouse chromaffin cells (imCCs) identified neddylation as a selective vulnerability: loss of UBE2F suppressed growth of SDH-deficient but not wild-type cells, while loss of UBE2M promoted growth specifically in SDH-deficient cells. Pevonedistat (and analog HA-9104) reduced UBE2F neddylation activity and selectively inhibited proliferation and induced apoptosis in SDH-deficient imCCs. The mechanism linking SDH deficiency to neddylation dependency is not yet fully characterized. Phase 1 data in hematologic malignancies established tolerability (NCT01011530); multiple Phase 2 trials ongoing. Not yet tested specifically in SDH-deficient GIST or PPGL (Al Khazal FJ et al., iScience 2026, PMID: 42181244, DOI: 10.1016/j.isci.2026.115885).",
    fda_approved: false,
    approved_indications: [],
