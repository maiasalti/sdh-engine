...
export const SEED_DRUGS: SeedDrug[] = [
  ...
  },
  {
    ...
    chembl_id: null,
    pubchem_cid: null,
    drug_class: "HSP90 inhibitor (second-generation, non-ansamycin, resorcinol-class)",
    mechanism_of_action:
      "Ganetespib (STA-9090) is a second-generation, non-ansamycin, resorcinol-based inhibitor of heat shock protein 90 (HSP90AA1/HSP90AB1), an ATP-dependent molecular chaperone that folds, matures, and stabilizes hundreds of client proteins including HIF-1α, HIF-2α, CDK4, AKT, VEGFR2, MET, and FGFR1. Ganetespib binds the HSP90 N-terminal nucleotide-binding pocket with nanomolar affinity, blocking ATPase cycling, preventing client protein maturation, and triggering ubiquitin-proteasomal degradation of client proteins via the CHIP/Hsp70/Hsp40 co-chaperone axis.\n\n**Mechanistic rationale — VHL-independent HIF-1α proteostatic dependence in SDH-deficient tumors:**\nHIF-1α protein stability is maintained by two independent proteasomal gatekeeping pathways. The canonical pathway is PHD-VHL-mediated: PHD1/2/3 hydroxylate HIF-1α prolyl residues → VHL recognizes the hydroxylation mark → VHL/CRL2 ubiquitin ligase polyubiquitinates HIF-1α → 26S proteasomal degradation. In SDH-deficient tumors, massive succinate accumulation competitively inhibits PHDs, blocking this pathway and creating constitutive pseudohypoxia. A second, VHL-independent pathway was established by Isaacs et al. (Cancer Cell 2002, PMID 12186565): HSP90 provides HIF-1α proteostatic stability independently of PHD/VHL, and geldanamycin treatment depletes HIF-1α protein by >80% in VHL-null cells (where the PHD-VHL pathway is constitutively absent) by routing it to proteasomal degradation via the CHIP/Hsp70/Hsp40 axis. In SDH-deficient tumors — where the PHD-VHL pathway is functionally equivalent to VHL-null — HSP90 therefore becomes the sole remaining mechanism preventing HIF-1α from proteasomal routing. HSP90 inhibition with ganetespib engages this VHL-independent degradation axis, depleting HIF-1α protein even under constitutive pseudohypoxia.\n\n**Critical distinction from belzutifan:**\nBelzutifan (Mechanism 1) occupies the HIF-2α PAS-B hydrophobic pocket and prevents HIF-2α/ARNT dimerization, suppressing HIF-2α transcriptional activity without degrading the protein. It has no effect on HIF-1α — the dominant HIF isoform in GIST and PPGL. Ganetespib, by contrast, depletes both HIF-1α AND HIF-2α proteins via proteasomal routing, eliminating not only their transcriptional output but their physical presence. This is mechanistically non-redundant with belzutifan and potentially more complete in tumors where HIF-1α drives the dominant pseudohypoxic program.\n\n**Co-client polypharmacology relevant to SDH-deficient biology:**\nGanetespib simultaneously depletes established HSP90 clients that are individually relevant to SDH-deficient tumor pathophysiology: (1) CDK4 — constitutively active due to CIMP-driven p16/CDKN2A silencing (Mechanism 24); (2) AKT — central PI3K/mTOR node (Mechanism 4); (3) VEGFR2/KDR — primary VEGF-driven angiogenesis receptor (Mechanism 3); (4) MET — HIF-1α transcriptional target driving invasive growth (Mechanism 20); (5) FGFR1 — FGFR amplification in SDH-deficient GIST subset (Mechanism 9). This poly-pharmacology — targeting at the chaperone level rather than at individual client receptors — is not achievable with any single-target inhibitor and is particularly appropriate for SDH-deficient tumors that co-activate multiple HIF-driven receptor tyrosine kinase pathways simultaneously.\n\n**Clinical development:**\nGanetespib was the most clinically advanced second-generation non-ansamycin HSP90 inhibitor. It offered substantially improved safety vs first-generation ansamycins: no benzoquinone-associated hepatotoxicity, reduced ocular toxicity, and oral-equivalent potency. Phase 1 trials established dosing in solid tumors (NCT00688116: twice-weekly, Synta Pharmaceuticals; NCT00687934: once-weekly, Synta Pharmaceuticals). An NCI Phase 1/2 trial explicitly enrolled sarcomas and gastrointestinal carcinomas (NCT02192541: ganetespib + ziv-aflibercept — providing direct context for use in mesenchymal/GI malignancies). Larger trials included Phase 2/3 in NSCLC (GALAXY-2) and Phase 2 in breast cancer. Synta Pharmaceuticals ultimately discontinued ganetespib development after the GALAXY-2 primary endpoint was not met; however, ganetespib is now an extensively characterized, off-patent compound with full human PK/PD and safety data enabling repurposing.\n\n**Key limitations:** (1) No experimental data tests ganetespib or any HSP90 inhibitor in SDH-deficient cell lines, tumor specimens, or animal models; the mechanistic argument extrapolates the Isaacs et al. 2002 geldanamycin result in VHL-null cells to ganetespib in PHD-inhibited SDH-deficient pseudohypoxic cells — a biologically reasonable one-step extrapolation requiring direct validation. (2) Ganetespib is no longer in active clinical development. (3) Global HSP90 inhibition depletes hundreds of clients simultaneously; toxicity stems from on-target depletion of essential HSP90-dependent proteins (ERBB2, CDK4 in normal cycling cells, AKT in multiple tissues). (4) The evidence_score of 30 (theoretical) reflects a well-established VHL-independent HIF-1α proteostasis mechanism (PMID 12186565) with no SDH-specific experimental evidence yet generated.",
    fda_approved: false,
    approved_indications: [],
    pathway_slugs: ["hsp90-hif1a-proteostasis", "hif-pseudohypoxia"],
    target_gene_symbols: ["HSP90AA1"],
    evidence_score: 30,
    status: "theoretical",
    tumor_type_applicability: ["all"],
    clinical_trial_ids: ["NCT00688116", "NCT00687934", "NCT02192541"],
  },
];
