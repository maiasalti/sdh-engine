...
export const SEED_DRUGS: SeedDrug[] = [
  ...
  },
  {
    ...
    chembl_id: null,
    pubchem_cid: null,
    drug_class: "Complex I (OXPHOS) inhibitor — NADH:ubiquinone oxidoreductase inhibitor",
    mechanism_of_action:
      "IACS-010759 (developed at the Institute for Applied Cancer Science, MD Anderson Cancer Center) is a potent, selective, orally bioavailable inhibitor of mitochondrial Complex I (NADH:ubiquinone oxidoreductase), with low-nanomolar affinity for the enzyme's proton-translocating arm (Ki ~1.2 nM). It belongs to the rotenone-class of Complex I inhibitors and blocks electron transfer from NADH to CoQ, halting Complex I-mediated NADH oxidation and proton translocation.\n\nThe mechanistic rationale for SDH-deficient tumours centres on a topology argument unique to this genotype: the 'Complex I OXPHOS bottleneck.' Complex II (succinate dehydrogenase) is the enzyme lost in these tumours. Its absence removes a major electron-donation route to CoQ. Simultaneously, the constitutive pseudohypoxic HIF-1α/2α programme driven by SDH loss suppresses fatty acid β-oxidation (via PDHK1 induction and CPT1A downregulation; Papandreou et al., Cell Metab 2006, PMID 16740476), minimising the electron-transfer flavoprotein (ETF) contribution to CoQ. The net result is that Complex I becomes the primary — and in pseudohypoxic SDH-deficient cells the sole significant — electron donor to CoQ.\n\nBlocking Complex I with IACS-010759 in this setting causes:\n1. **Complete ETC electron flow cessation** — unlike SDH-intact cells (where Complex II electrons sustain partial CoQ reduction, Complex III proton pumping, and OXPHOS even when Complex I is blocked), SDH-deficient cells have no electron source that bypasses Complex I. The entire ETC collapses.\n2. **Mitochondrial membrane potential (ΔΨm) loss** — without Complex I proton pumping and no Complex II to feed Complex III, proton translocation is abolished, ΔΨm collapses, and ATP synthesis via ATP synthase (Complex V) fails.\n3. **NAD⁺ depletion** — NADH cannot be converted to NAD⁺, impairing glycolysis (GAPDH requires NAD⁺) and the malate-aspartate shuttle, reducing aspartate biosynthesis. Birsoy et al. (Cell 2015, PMID 26232224) demonstrated that ETC-impaired cells have an absolute NAD⁺ dependency for aspartate and proliferative capacity, providing biochemical precedent.\n4. **Cascading DHODH failure** — SDH loss already suppresses de novo pyrimidine synthesis via succinate-mediated ATCase inhibition (Mechanism 17; Hart et al., Nat Metab 2026, PMID 42082831). ΔΨm collapse slows Complex III-mediated CoQH₂ re-oxidation → CoQH₂ accumulates → oxidised CoQ (the DHODH electron acceptor) becomes limiting → DHODH (step 4 of pyrimidine synthesis) fails → SDH-deficient cells sustain a second hit to the already-fragile pyrimidine synthesis pathway via an ETC-coupled mechanism mechanistically distinct from direct DHODH inhibition.\n\nIn SDH-intact cells, the same Complex I inhibition causes only partial ETC disruption: Complex II continues to supply electrons to CoQ → Complex III still pumps protons → ΔΨm is partially maintained → DHODH still has access to oxidised CoQ. The severity of Complex I blockade is therefore amplified in SDH-deficient tumours — a synthetic lethality analogous in logic to the BRCAness direction but operating through the OXPHOS bottleneck rather than DNA repair.\n\nClinical data: Molina et al. (Nat Med 2018, PMID 29892061) reported Phase 1 dose-escalation data for IACS-010759 in relapsed/refractory AML and advanced solid tumours (NCT03291938), establishing pharmacokinetics, target engagement (plasma lactate increase as on-target pharmacodynamic marker of Complex I inhibition), and early anti-tumour signals. Dose-limiting toxicities included Grade 3 lactic acidosis and fatigue; manageable with lactate monitoring and careful dose selection. No SDH-deficient-specific clinical or preclinical data published.\n\nKey limitation: No SDH-deficient-specific preclinical experiments reported for IACS-010759 or any selective Complex I inhibitor. Validation in SDHA-null GIST cell models, SDHB-KO chromaffin cells (hPheo1 model), or patient-derived SDH-deficient PPGL organoids is the critical next step. The degree to which SDH-deficient pseudohypoxic tumours rely on FAO/ETF in vivo must be confirmed to validate the bottleneck geometry.",
    fda_approved: false,
    approved_indications: [],
    pathway_slugs: ["complex-i-oxphos-bottleneck", "oxidative-stress-ros"],
    target_gene_symbols: ["MT-ND1"],
    evidence_score: 25,
    status: "theoretical",
  },
];
