...
export const SEED_DRUGS: SeedDrug[] = [
  ...
  },
  {
    ...
    chembl_id: null,
    pubchem_cid: null,
    drug_class: "Pan-FGFR inhibitor (FGFR1–4)",
    mechanism_of_action:
      "Orally available pan-FGFR inhibitor (FGFR1–4) that blocks FGFR kinase activity and downstream RAS/MAPK and PI3K/AKT signaling. In SDH-deficient GIST, the mechanistic target is an epigenetic-driven FGF3/FGF4 autocrine loop: SDH loss causes genome-wide DNA hypermethylation, which silences CTCF chromatin insulator elements flanking the FGF3/FGF4 locus (chromosome 11q13), derepressing these proto-oncogenes. The resulting autocrine FGFR1 activation drives tumor proliferation independently of kinase-mutant drivers. A Phase 2 trial (NCT04595747) of rogaratinib in 24 patients with advanced SDH-deficient GIST achieved an objective response rate of 41.7% (10/24 partial responses) and a median progression-free survival of 31.0 months (95% CI 20.2–NR) — the most active targeted agent in this indication to date. FGF3 and FGF4 plasma levels tracked with pharmacodynamic response. Toxicities were manageable (hyperphosphatemia, fatigue, diarrhea). Reference: Merriam et al., Nat Med 2026, PMID 42191879.",
    fda_approved: false,
    approved_indications: [],
  ...
  },
  {
    ...
    drug_class: "Pan-FGFR inhibitor (FGFR1–4)",
    mechanism_of_action:
      "Orally bioavailable pan-FGFR inhibitor (FGFR1–4) FDA-approved for FGFR-altered locally advanced or metastatic urothelial carcinoma. The mechanism applicable to SDH-deficient GIST is identical to rogaratinib: blocking FGFR1 kinase activity interrupts the FGF3/FGF4 autocrine loop created by epigenetic insulator disruption downstream of SDH loss. No clinical data exist yet in SDH-deficient GIST, but the FDA approval status makes it the most accessible FGFR inhibitor for off-label use pending further trial data. Rogaratinib's Phase 2 results (41.7% ORR, Merriam et al., Nat Med 2026, PMID 42191879) provide strong mechanistic support for the FGFR target class in this disease.",
    fda_approved: true,
    approved_indications: [
      "FGFR-altered locally advanced or metastatic urothelial carcinoma",
    ],
  ...
  },
  {
    ...
    chembl_id: null,
    pubchem_cid: null,
    drug_class: "NEDD8-activating enzyme (NAE1) inhibitor",
    mechanism_of_action:
      "Potent, selective inhibitor of NAE1 (NEDD8-activating enzyme), the E1 enzyme that initiates the neddylation cascade. Neddylation (covalent conjugation of NEDD8 to cullin-1/2/3/4/5 scaffolds) is required to activate CRL (Cullin-RING Ligase) E3 ubiquitin complexes, which control proteasomal degradation of cell cycle regulators (p27, CDT1, WEE1, CDC25A) and DNA damage response proteins. Pevonedistat blocks all cullin neddylation, causing CRL substrate accumulation, DNA re-replication, and proteotoxic stress. Rationale in SDH deficiency comes from an unbiased CRISPR-Cas9 genetic screen in immortalized SDH-deficient mouse chromaffin cells (Al Khazal et al., iScience 2026, PMID 42181244): the neddylation pathway emerged as a selective dependency, with UBE2F (neddylation E2) loss suppressing growth specifically in SDH-deficient cells, and pevonedistat/MLN4924 selectively inhibiting proliferation of SDH-deficient versus normal chromaffin cells. Translational path: pevonedistat has completed Phase 1/2 trials in hematologic malignancies establishing safety (NCT01814826, NCT02610777); antitumor activity was seen in MDS and AML. No clinical data yet in SDH-deficient solid tumors. Key consideration: neddylation inhibition has broad effects on ubiquitin-mediated protein homeostasis — therapeutic window requires careful evaluation in SDH-deficient tumor models before clinical translation.",
    fda_approved: false,
    approved_indications: [],
    pathway_slugs: ["neddylation-ubiquitin"],
    target_gene_symbols: ["NAE1"],
    evidence_score: 38,
    status: "preclinical",
  },
];
