...
export const SEED_DRUGS: SeedDrug[] = [
  ...
  },
  {
    ...
    mechanism_of_action:
      "Orally bioavailable pan-FGFR kinase inhibitor (BAY 1163877) that competitively blocks ATP binding to FGFR1, FGFR2, FGFR3, and FGFR4. In SDH-deficient GIST specifically, genome-wide CIMP from SDH loss hypermethylates CTCF-binding genomic insulators, collapsing topological domain boundaries and allowing previously silenced enhancers to drive aberrant co-expression of FGF3 and FGF4. These ligands activate an FGFR1-mediated autocrine survival loop that is absent in normal or KIT-mutant GIST. A prospective Phase 2 trial (NCT04595747) in 24 patients with advanced SDH-deficient GIST yielded a 41.7% objective response rate (10/24 partial responses) and a median progression-free survival of 31.0 months (95% CI 20.2–not reached), with 1-year PFS of 77.4%. Toxicities (hyperphosphatemia, fatigue, diarrhea) were manageable. Serial biopsies confirmed FGFR target engagement via phospho-FRS2 reduction. Critically, FGF3/FGF4 overexpression and FGFR1 autocrine activity are mechanistically caused by SDH loss rather than being coincidental — this is a direct consequence of the CIMP phenotype. Primary reference: Merriam P et al., Nat Med 2026, PMID: 42191879, DOI: 10.1038/s41591-026-04376-9.",
    fda_approved: false,
    approved_indications: [],
  ...
  },
  {
    ...
    chembl_id: null,
    pubchem_cid: null,
    drug_class: "NEDD8-activating enzyme (NAE) inhibitor / Neddylation inhibitor",
    mechanism_of_action:
      "Adenosine sulfamate analogue that forms a covalent adduct with NEDD8 in the active site of the NEDD8-activating enzyme (NAE; NAE1–UBA3 heterodimer), irreversibly blocking the first step of the neddylation cascade. Neddylation of Cullin subunits (CUL1/2/3/4A/4B/5/7) is required for activation of Cullin-RING E3 ubiquitin ligase complexes (CRLs), which regulate turnover of hundreds of substrates including CDT1, p27, p21, CDK inhibitors, and DNA damage response proteins. An unbiased CRISPR-Cas9 genetic screen in Sdhb-deficient immortalized mouse chromaffin cells (modeling PPGL) identified the neddylation branch — specifically UBE2F loss — as a selective synthetic-lethal vulnerability: pevonedistat (MLN4924) and HA-9104 (a UBE2F-selective inhibitor) reduced proliferation specifically in SDH-deficient cells compared with isogenic controls. The mechanism likely reflects elevated proteotoxic and metabolic stress from SDH loss rendering these cells more dependent on CRL-mediated protein quality control. Pevonedistat has clinical-stage safety data from Phase 1/2 trials in AML, MDS, and multiple myeloma (NCT02610777, NCT01814826), where the principal dose-limiting toxicity is hepatotoxicity at higher exposures. Primary reference: Al Khazal FJ et al., iScience 2026, PMID: 42181244, DOI: 10.1016/j.isci.2026.115885. Key limitation: preclinical evidence is in mouse chromaffin cells (PGL/PCC model) — validation in SDH-deficient GIST cell lines or patient-derived models is needed.",
    fda_approved: false,
    approved_indications: [],
    pathway_slugs: ["neddylation-protein-homeostasis"],
