...
export const SEED_DRUGS: SeedDrug[] = [
  ...
  },
  {
    ...
    chembl_id: null,
    pubchem_cid: null,
    drug_class: "CHK1/CHK2 inhibitor",
    mechanism_of_action:
      "Prexasertib (LY2606368) is a potent, selective inhibitor of checkpoint kinase 1 (CHK1/CHEK1; IC₅₀ ~1 nM) and CHK2 (CHEK2; IC₅₀ ~8 nM), developed by Eli Lilly. CHK1 is the master intra-S-phase and G2/M checkpoint kinase: activated by ATR at stalled replication forks, it phosphorylates CDC25A/B/C phosphatases (targeting them for degradation/nuclear exclusion) to prevent premature CDK1/CDK2-driven mitotic entry, and directly phosphorylates RAD51 at Ser309 to enable RAD51 loading at stalled forks for HR-mediated fork restart.\n\nThe SDH-specific rationale rests on a compound HR deficiency with two parallel arms that simultaneously impair HR in all SDH-deficient cells:\n\n1. HIF-1α-driven RAD51 transcriptional suppression: SDH loss → succinate → PHD inhibition → constitutive HIF-1α stabilization (pseudohypoxia). Bindra et al. (Mol Cell Biol 2004, PMID 15367671) established that HIF-1α stabilization transcriptionally suppresses RAD51 via E2F4/p130 repressor recruitment to the RAD51 promoter, reducing RAD51 mRNA and protein in hypoxic cells — an effect reversed by HIF-1α knockdown. In SDH-deficient tumors, constitutive pseudohypoxia creates persistent, oxygen-independent RAD51 suppression, reducing the RAD51 protein pool available for HR-mediated fork rescue throughout the cell cycle.\n\n2. Succinate→KDM4B→BRCAness: Accumulated succinate competitively inhibits KDM4A/KDM4B (H3K9me3 demethylases) → H3K9me3 persists at DSB chromatin → TIP60 (KAT5) histone acetyltransferase cannot acetylate H4K16 at damage sites → ATM kinase activation is impaired → HR initiation fails. Sulkowski et al. (Nat Genet 2018, PMID 30013182; Nature 2020, PMID 32494005) established this BRCAness phenotype in SDH-deficient cell lines and demonstrated synthetic lethality with olaparib.\n\nIn cells with this compound HR deficiency, CHK1 becomes the critical non-redundant fork-protection mechanism. When prexasertib inhibits CHK1: (a) intra-S checkpoint enforcement fails — cells with stalled forks are forced into premature mitosis; (b) RAD51 Ser309 phosphorylation is abolished — the already-suppressed RAD51 pool cannot be mobilized to forks even when available; (c) stalled forks collapse into DSBs that the doubly HR-impaired cell cannot resolve (reduced RAD51 + impaired ATM/HR initiation), producing catastrophic replication failure.\n\nThis mechanism is conceptually distinct from olaparib/PARP inhibition (Mechanism 14 — exploits BRCAness via BER-to-DSB intermediates) and POLQ inhibition (Mechanism 20 — blocks backup alt-EJ repair of already-collapsed forks). CHK1 inhibition acts upstream: it abrogates the checkpoint that prevents fork collapse, rather than blocking post-collapse repair.\n\nClinical data: Konstantinopoulos et al. (Gynecol Oncol 2022, PMID 36192237; NCT03414047) demonstrated single-agent prexasertib activity in platinum-resistant high-grade serous ovarian cancer including BRCA-wildtype tumors, with replication catastrophe as the proposed mechanism. Do et al. (Clin Cancer Res 2021, PMID 34131002; NCT02203513) evaluated prexasertib plus olaparib in BRCA1/2-mutant solid tumors, showing combination activity with reversible Grade 3–4 neutropenia as the primary dose-limiting toxicity (manageable with G-CSF).\n\nKey limitations: (1) No published data tests prexasertib in any SDH-deficient cancer model. (2) CHK1 inhibitors show activity in BRCA-wildtype tumors via endogenous replication stress, so the additional selectivity conferred by the compound HR deficiency in SDH-deficient cells is mechanistically predicted but experimentally unconfirmed. (3) Prexasertib is investigational only (not FDA-approved). (4) Evidence_score of 22 (theoretical) reflects a mechanistically coherent argument from primary literature (Bindra 2004, PMID 15367671; Sulkowski 2018/2020, PMIDs 30013182/32494005) but no SDH-specific CHK1 inhibitor data.",
    fda_approved: false,
    approved_indications: [],
    pathway_slugs: ["chk1-checkpoint-abrogation", "sdh-driven-hrd"],
    target_gene_symbols: ["CHEK1"],
    evidence_score: 22,
    status: "theoretical",
    tumor_type_applicability: ["all"],
    clinical_trial_ids: ["NCT03414047", "NCT02203513"],
  },
];
