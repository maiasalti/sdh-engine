...
export const SEED_TARGETS: SeedTarget[] = [
  ...
  },
  {
    ...
    uniprot_id: "P78527",
    pathway_slug: "nhej-dna-pkcs-backup-repair",
    target_type: "synthetic_lethal",
    description:
      "DNA-dependent protein kinase catalytic subunit (DNA-PKcs), encoded by PRKDC, is the catalytic core of the DNA-PK holoenzyme complex (DNA-PKcs + Ku70/XRCC6 + Ku80/XRCC5). DNA-PK is assembled at double-strand break (DSB) termini when the Ku heterodimer recruits DNA-PKcs; activated DNA-PKcs autophosphorylates at Ser2056 and Thr2609 and phosphorylates downstream classical NHEJ effectors (XRCC4, LIG4, Artemis, PAXX) to drive DSB end-processing and ligation. DNA-PKcs is the master effector of c-NHEJ — the predominant DSB repair pathway in G1 and early-S phase.\n\nIn SDH-deficient tumors, the BRCAness phenotype (succinate → KDM4A/KDM4B inhibition → H3K9me3 at DSBs → impaired TIP60/ATM → HR deficiency; Sulkowski et al. Nat Genet 2018, PMID 30013182; Nature 2020, PMID 32494005) leaves c-NHEJ as the primary remaining DSB repair pathway. Inhibiting DNA-PKcs in BRCAness-positive SDH-deficient cells removes this backup, causing catastrophic DSB accumulation selectively in cells that cannot fall back on HR. Anastasia et al. (Mol Cancer Ther 2022, PMID 35149547) showed that the selective DNA-PKcs inhibitor AZD7648 (elimusertib) potentiated olaparib specifically in BRCA-deficient ovarian cancer PDX models but not in BRCA-proficient controls, directly establishing BRCAness-selective DNA-PKcs synthetic lethality — the same mechanistic principle applicable to BRCAness-positive SDH-deficient tumors. Elimusertib (AZD7648, AstraZeneca) is the clinical-stage PRKDC inhibitor evaluated in Phase 1/2a (NCT03907969, completed, n=30).\n\nMechanistic distinction from related DDR targets in this engine: POLQ (Mechanism 18) executes alt-EJ/TMEJ, an error-prone microhomology-mediated backup distinct from c-NHEJ; CHEK1 (Mechanism 28) stabilizes stalled replication forks as a checkpoint kinase; PRKDC/DNA-PKcs executes the ligation step of classical NHEJ for DSB resolution. All three are non-redundant backup mechanisms in BRCAness-positive cells.",
  },
];
