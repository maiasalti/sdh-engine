...
export const SEED_TARGETS: SeedTarget[] = [
  ...
  },
  {
    ...
    uniprot_id: "P11166",
    pathway_slug: "warburg-glycolytic-dependency",
    target_type: "downstream",
    description:
      "Facilitative glucose transporter 1 (GLUT1/SLC2A1) is the primary transmembrane glucose importer in most mammalian cells and the key effector of HIF-1α-driven aerobic glycolysis (the Warburg effect). SLC2A1 transcription is directly activated by HIF-1α via canonical hypoxia-response elements (HREs) in the SLC2A1 promoter — a well-established HIF-1α target gene in canonical hypoxia and in pseudohypoxic tumor microenvironments. In SDH-deficient tumors, constitutive HIF-1α/2α stabilization (via succinate-mediated PHD inhibition) drives persistent SLC2A1 upregulation regardless of oxygen tension. The functional consequence is elevated glucose uptake and glycolytic flux: FDG-PET avidity in SDH-deficient PPGL is the clinical imaging correlate (PMID 42454478). Chan et al. (Sci Transl Med 2011, PMID 21697397) established selective GLUT1-dependency in VHL-null renal cancer cells — which are pseudohypoxic via the same HIF-stabilization mechanism — demonstrating that STF-31, a GLUT1 inhibitor, kills VHL-null cells while VHL-restored isogenic controls survive: GLUT1 dependence is a synthetic lethality arising from pseudohypoxic HIF-1α-driven GLUT1 upregulation, not from GLUT1 overexpression per se. BAY-876 (Siebeneicher et al., ChemMedChem 2016, PMID 27595555) is the highest-potency and most selective GLUT1 inhibitor described to date (IC50 ~2 nM for GLUT1; >50-fold selectivity over GLUT2/3/4), validated in cancer cell lines including glucose-uptake inhibition and cell viability assays.",
  },
];
