...
export const SEED_TARGETS: SeedTarget[] = [
  ...
  {
    gene_symbol: "CDK7",
    name: "Cyclin-dependent kinase 7 (CAK subunit / Pol II CTD kinase)",
    uniprot_id: "P50613",
    pathway_slug: "epigenetic-dysregulation",
    target_type: "synthetic_lethal",
    description:
      "RNA Pol II CTD kinase and CDK-activating kinase (CAK). CDK7, as the catalytic subunit of the trimeric CAK complex (CDK7–cyclin H–MAT1), serves two essential functions: it phosphorylates the Ser5 and Ser7 positions of the heptapeptide repeat in the RNA Pol II C-terminal domain (CTD), licensing transcriptional initiation and early elongation at gene promoters, and it activates CDK1, CDK2, and CDK4/6 by phosphorylating their T-loop threonines. Transcription elongation from paused Pol II additionally requires P-TEFb (CDK9/cyclin T), but CDK7-mediated Ser5/Ser7 phosphorylation is the essential initiating event that commits Pol II to productive transcription. Critically, super-enhancers — clusters of enhancers with disproportionately high transcription factor and Mediator occupancy — recruit far greater Pol II density than typical enhancers and are therefore disproportionately sensitive to CDK7 dosage: Kwiatkowski et al. (Science 2014, PMID 25316025) demonstrated with the covalent CDK7 inhibitor THZ1 that CDK7 inhibition selectively collapses transcription from super-enhancer-driven oncogenes relative to housekeeping genes, providing a therapeutic window in cancer. In SDH-deficient GIST, CIMP-driven DNA hypermethylation disrupts CTCF insulator elements flanking the FGF3/FGF4 locus, creating an ectopic super-enhancer that drives high-level FGF3/FGF4 autocrine signaling (Merriam et al., Nat Med 2026, PMID 42191879). CDK7 inhibition would selectively collapse transcription from this ectopic super-enhancer — acting at the initiating Pol II CTD phosphorylation step, upstream of BRD4 (super-enhancer reader; birabresib direction) and far upstream of FGFR1 (downstream receptor; rogaratinib direction). Target of SY-5609 (Syros Pharmaceuticals; selective non-covalent; >100-fold selectivity over CDK4/6/9/12; Phase 1 NCT04247126).",
  },
];
