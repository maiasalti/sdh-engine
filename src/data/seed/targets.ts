...
export const SEED_TARGETS: SeedTarget[] = [
  ...
  },
  {
    ...
    target_type: "synthetic_lethal",
    description:
      "Serine/threonine protein kinase (PI3K-related kinase, PIKK family) that forms the catalytic core of the DNA-dependent protein kinase (DNA-PK) complex, together with the KU70/XRCC6 and KU80/XRCC5 regulatory heterodimer. PRKDC is recruited to DNA double-strand breaks (DSBs) by prior KU70/KU80 loading at blunt or near-blunt DSB ends, where it undergoes autophosphorylation at Ser2056 and Thr2609 clusters. Activated DNA-PK orchestrates classical non-homologous end joining (c-NHEJ) — the predominant DSB repair pathway for the quantitatively dominant class of double-ended blunt DSBs (~90% of all cellular DSBs), including those generated by ionizing radiation, topoisomerase poisons, and replication fork collapse.\n\nIn SDH-deficient tumors, the BRCAness phenotype (Sulkowski et al. Nat Genet 2018, PMID 30013182; Nature 2020, PMID 32494005) — epigenetic HR deficiency driven by succinate-mediated KDM4A/KDM4B inhibition and H3K9me3 persistence at DSB sites — forces compensatory upregulation of NHEJ as the primary fallback DSB repair route. This creates a synthetic lethal dependency on PRKDC: BRCAness-positive SDH-deficient cells cannot fall back on HR when NHEJ is simultaneously blocked, resulting in lethal DSB accumulation or shunting to highly error-prone TMEJ/POLQ-mediated end joining.\n\nThis mechanism is mechanistically distinct from POLQ/TMEJ (Mechanism 14, ART558) — POLQ handles complex one-ended DSBs at collapsed forks with microhomology, while PRKDC/NHEJ handles the majority of simple double-ended DSBs. Blocking both pathways simultaneously (peposertib + ART558) could create additive or synergistic lethality. Peposertib (M3814/MSC2490484A, Merck KGaA) is a highly selective, ATP-competitive PRKDC kinase inhibitor with IC50 ~3 nM in clinical Phase 1b/2 development.",
  },
];
