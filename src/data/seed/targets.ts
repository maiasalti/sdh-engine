...
export const SEED_TARGETS: SeedTarget[] = [
  ...
  },
  {
    ...
    name: "Ferredoxin-1",
    uniprot_id: "Q14213",
    pathway_slug: "cuproptosis-lipoylation-mtfas",
    target_type: "direct",
    description:
  ...
  },
  {
    ...
    target_type: "metabolic",
    description:
      "Cytoplasmic enzyme that cleaves citrate into acetyl-CoA and oxaloacetate, consuming one ATP. ACLY is the obligate gateway converting mitochondrially exported (or reductively carboxylated) citrate into cytoplasmic acetyl-CoA for de novo fatty acid synthesis (FASN/ACC), histone acetylation, and cholesterol biosynthesis.\n\nIn SDH-deficient tumors, ACLY becomes the critical bottleneck of an altered metabolic flow. SDH (Complex II) inactivation truncates the forward TCA cycle at succinate → fumarate, blocking canonical glucose → citrate synthesis. SDH-deficient cells compensate via reductive carboxylation: glutamine → glutamate → α-KG → isocitrate → citrate (reverse IDH2, NADPH-dependent). This reductively generated mitochondrial citrate is exported to the cytoplasm via SLC25A1 and cleaved by ACLY. Mullen et al. (Nature 2012, PMID 22101431) established by 13C isotopic tracing that ETC-deficient cells — including fumarate hydratase-deficient cells (enzyme immediately downstream of SDH) — rely on reductive carboxylation as the dominant citrate source, with ACLY as the committed cleavage step.\n\nBecause SDH-deficient cells cannot access forward-TCA-derived acetyl-CoA, their ACLY activity is non-redundant — it is the primary cytoplasmic acetyl-CoA source for lipid synthesis and proliferative demand. ACLY overexpression correlates with tumor grade in multiple cancer types (Migita et al., Cancer Res 2008, PMID 18922930). Bempedoic acid (ETC-1002/Nexletol), FDA-approved for LDL-lowering, inhibits ACLY via its active CoA thioester metabolite and is the clinical-stage candidate for oncologic ACLY inhibition in SDH-deficient tumors.",
  },
  {
    gene_symbol: "IGF1R",
    name: "Insulin-like growth factor 1 receptor (IGF-1R; CD221)",
    uniprot_id: "P08069",
    pathway_slug: "hif-igf2-igf1r-growth-signaling",
    target_type: "downstream",
    description:
      "Single-pass transmembrane receptor tyrosine kinase (RTK) that binds IGF1 and IGF2 with high affinity, and insulin with lower affinity. Upon ligand binding, IGF1R undergoes conformational change → transautophosphorylation of Tyr1158/Tyr1162/Tyr1163 in the activation loop → full kinase activation → phosphorylation of insulin receptor substrate 1/2 (IRS1/IRS2) → PI3K/AKT/mTOR (survival, growth) and RAS/RAF/MEK/ERK (proliferation) pathway activation.\n\nIn SDH-deficient pseudohypoxic tumours, IGF2 is massively overexpressed through two reinforcing mechanisms: (1) HIF-1α/2α constitutively transcribes IGF2 via HREs in its promoter (same mechanism as VEGF and CAIX); and (2) CIMP-driven methylation of the H19 imprinting control region silences H19, de-repressing the adjacent IGF2 locus and enabling biallelic IGF2 expression (loss of imprinting). The result is an autocrine/paracrine IGF2 loop that constitutively activates IGF1R in SDH-deficient tumour cells.\n\nFounding observation: Nielsen et al. (Endocr Relat Cancer 2015, PMID 26400872) showed IGF2 overexpression in 100% of pheochromocytomas in a 10-PCC cohort, and 85% of adrenocortical carcinomas — both adrenal tumour types with IGF2/H19 locus dysregulation. Methylation of the H19 ICR correlated directly with IGF2 overexpression in PCCs, establishing the epigenetic mechanism.\n\nTherapeutic rationale: IGF1R is the druggable effector of this autocrine loop. Linsitinib (OSI-906; Astellas) is a potent, oral, selective dual IGF1R/IR-A kinase inhibitor (IGF1R IC50 ~35 nM; IR IC50 ~75 nM). It was evaluated in a Phase 3 randomised controlled trial in adrenocortical carcinoma (NCT00924989; Fassnacht et al. Lancet Oncol 2015, PMID 25795408) — an IGF2-overexpressing tumour with an analogous driving mechanism — establishing clinical-grade pharmacology, tolerability, and biomarker data.",
  },
  {
    gene_symbol: "HSP90AA1",
    name: "Heat shock protein HSP 90-alpha (HSP90α)",
    uniprot_id: "P07900",
    pathway_slug: "hsp90-hif-client-chaperone",
    target_type: "direct",
    description:
      "Constitutively expressed cytoplasmic ATP-dependent molecular chaperone that maintains client proteins in stable, functionally competent conformations. HSP90α (encoded by HSP90AA1) is required for folding, stabilization, and activation of ~200 client proteins including kinases (HER2, BCR-ABL, CDK4), transcription factors, and critically HIF-1α and HIF-2α.\n\nHIF-1α is an obligate HSP90 client protein: HSP90 maintains the HIF-1α PAS-B domain in a conformation competent for VHL interaction under normoxia, and in an active transcription-competent conformation under hypoxia. Isaacs et al. demonstrated that HSP90 inhibition disrupts HIF-1α stability via a VHL-independent, proteasome-dependent pathway — distinct from the canonical PHD/VHL oxygen-sensing route. Minet et al. (Biochem Biophys Res Commun 2000, PMID 10930466) established the HSP90-HIF-1α physical interaction, and Katschinski et al. (Cell Physiol Biochem 2004, PMID 15989551) confirmed HSP90α as the dominant chaperone isoform maintaining HIF-1α client stability.\n\nCritical dose-response nuance (Ibrahim et al. Cancer Res 2005, PMID 16322259): low-dose HSP90 inhibition can paradoxically increase HIF-1α protein levels by impairing the VHL binding interface while not achieving the threshold required for proteasomal client routing; high-dose inhibition drives net HIF-1α reduction through a post-translational, proteasome-dependent mechanism. Ganetespib (STA-9090), a second-generation resorcinol-based HSP90 inhibitor, achieves high-affinity HSP90 occupancy (Kd ~1 nM) and demonstrated HIF-1α client degradation at pharmacologically achievable concentrations in preclinical models, without the hepatotoxicity of first-generation benzoquinone ansamycin agents (geldanamycin, 17-AAG).\n\nIn SDH-deficient tumors, constitutive PHD inhibition by accumulated succinate locks HIF-1α/2α in a permanently stabilized, transcriptionally active state — making the HSP90 chaperone machinery that maintains this active pseudohypoxic proteome an obligate survival dependency. NCT01039519 (Phase 2 ganetespib in imatinib-refractory GIST, n=27, completed) is the most direct clinical anchor for HSP90 inhibition in GIST.",
  },
];
